...
cells.append(new_markdown_cell(
    ...
    "do the same here for `rag-system/.env`."
))
cells.append(new_code_cell(
    ...
    "# relative strings meant to be resolved against rag-system/ as CWD (same\n"
    ...
    "# (rag-system/notebooks/), not rag-system/ -- so anchor them explicitly\n"
    "# to this notebook's parent directory rather than relying on CWD.\n"
    "_RAG_SYSTEM_ROOT = os.path.abspath('..')\n"
    "cfg.index_dir = os.path.join(_RAG_SYSTEM_ROOT, cfg.index_dir)\n"
    "cfg.processed_dir = os.path.join(_RAG_SYSTEM_ROOT, cfg.processed_dir)\n"
    "cfg.raw_csv = os.path.join(_RAG_SYSTEM_ROOT, cfg.raw_csv)\n"
    "\n"
